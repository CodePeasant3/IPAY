...
#ifndef tsl_2fprotobuf_2fdistributed_5fruntime_5fpayloads_2eproto_2epb_2eh
#define tsl_2fprotobuf_2fdistributed_5fruntime_5fpayloads_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:tensorflow.distributed_runtime.WorkerPossiblyRestarted) */ {
 public:
  ...
  void operator delete(WorkerPossiblyRestarted* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  WorkerPossiblyRestarted* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.distributed_runtime.GrpcPayloadsLost) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GrpcPayloadsLost* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GrpcPayloadsLost* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.distributed_runtime.GrpcPayloadContainer) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GrpcPayloadContainer* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GrpcPayloadContainer* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tsl_2fprotobuf_2fdistributed_5fruntime_5fpayloads_2eproto_2epb_2eh
