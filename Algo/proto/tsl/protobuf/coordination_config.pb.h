...
#ifndef tsl_2fprotobuf_2fcoordination_5fconfig_2eproto_2epb_2eh
#define tsl_2fprotobuf_2fcoordination_5fconfig_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:tensorflow.CoordinatedJob) */ {
 public:
  ...
  void operator delete(CoordinatedJob* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CoordinatedJob* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.CoordinationServiceConfig) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CoordinationServiceConfig* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CoordinationServiceConfig* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tsl_2fprotobuf_2fcoordination_5fconfig_2eproto_2epb_2eh
