...
#ifndef tsl_2fprotobuf_2fdnn_2eproto_2epb_2eh
#define tsl_2fprotobuf_2fdnn_2eproto_2epb_2eh
...
extern const uint32_t AlgorithmProto_MathType_internal_data_[];
...
constexpr DataType DataType_MAX = static_cast<DataType>(12);
constexpr int DataType_ARRAYSIZE = 12 + 1;
const ::google::protobuf::EnumDescriptor*
DataType_descriptor();
template <typename T>
...
extern const uint32_t DataLayout_internal_data_[];
...
extern const uint32_t FilterLayout_internal_data_[];
...
extern const uint32_t ConvolutionMode_internal_data_[];
...
extern const uint32_t ConvolutionKind_internal_data_[];
...
extern const uint32_t NormKind_internal_data_[];
...
extern const uint32_t FusedMHAKind_internal_data_[];
...
extern const uint32_t FMHAMaskKind_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:stream_executor.dnn.TensorDescriptorProto) */ {
 public:
  ...
  void operator delete(TensorDescriptorProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  TensorDescriptorProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:stream_executor.dnn.ConvolutionDescriptorProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ConvolutionDescriptorProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ConvolutionDescriptorProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:stream_executor.dnn.AlgorithmProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AlgorithmProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AlgorithmProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:stream_executor.dnn.AlgorithmConfigProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AlgorithmConfigProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AlgorithmConfigProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tsl_2fprotobuf_2fdnn_2eproto_2epb_2eh
