...
#ifndef tsl_2fprotobuf_2frpc_5foptions_2eproto_2epb_2eh
#define tsl_2fprotobuf_2frpc_5foptions_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:tensorflow.RPCOptions) */ {
 public:
  ...
  void operator delete(RPCOptions* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RPCOptions* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tsl_2fprotobuf_2frpc_5foptions_2eproto_2epb_2eh
