...
#ifndef tsl_2fprotobuf_2fhistogram_2eproto_2epb_2eh
#define tsl_2fprotobuf_2fhistogram_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:tensorflow.HistogramProto) */ {
 public:
  ...
  void operator delete(HistogramProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  HistogramProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // tsl_2fprotobuf_2fhistogram_2eproto_2epb_2eh
