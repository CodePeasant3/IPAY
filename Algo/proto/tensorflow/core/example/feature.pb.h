...
/* @@protoc_insertion_point(class_definition:tensorflow.FeatureList) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FeatureList* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FeatureList* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.Features) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(Features* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Features* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.FeatureLists) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FeatureLists* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FeatureLists* New(::google::protobuf::Arena* arena = nullptr) const {
