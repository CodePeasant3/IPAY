...
/* @@protoc_insertion_point(class_definition:tensorflow.VarLenFeatureProto) */ {
 public:
  ...
  void operator delete(VarLenFeatureProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  VarLenFeatureProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.FixedLenFeatureProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FixedLenFeatureProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FixedLenFeatureProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.FeatureConfiguration) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FeatureConfiguration* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FeatureConfiguration* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ExampleParserConfiguration) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ExampleParserConfiguration* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ExampleParserConfiguration* New(::google::protobuf::Arena* arena = nullptr) const {
