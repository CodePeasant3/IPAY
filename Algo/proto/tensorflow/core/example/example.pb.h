...
/* @@protoc_insertion_point(class_definition:tensorflow.Example) */ {
 public:
  ...
  void operator delete(Example* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  Example* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.SequenceExample) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SequenceExample* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SequenceExample* New(::google::protobuf::Arena* arena = nullptr) const {
