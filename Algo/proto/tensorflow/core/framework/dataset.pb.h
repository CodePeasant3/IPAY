...
/* @@protoc_insertion_point(class_definition:tensorflow.data.CompressedComponentMetadata) */ {
 public:
  ...
  void operator delete(CompressedComponentMetadata* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CompressedComponentMetadata* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.CompressedElement) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CompressedElement* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CompressedElement* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.UncompressedElement) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(UncompressedElement* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  UncompressedElement* New(::google::protobuf::Arena* arena = nullptr) const {
