...
/* @@protoc_insertion_point(class_definition:tensorflow.ResourceHandleProto.DtypeAndShape) */ {
 public:
  ...
  void operator delete(ResourceHandleProto_DtypeAndShape* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ResourceHandleProto_DtypeAndShape* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ResourceHandleProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ResourceHandleProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ResourceHandleProto* New(::google::protobuf::Arena* arena = nullptr) const {
