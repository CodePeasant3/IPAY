...
/* @@protoc_insertion_point(class_definition:tensorflow.GraphDebugInfo.FileLineCol) */ {
 public:
  ...
  void operator delete(GraphDebugInfo_FileLineCol* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GraphDebugInfo_FileLineCol* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.GraphDebugInfo.StackTrace) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GraphDebugInfo_StackTrace* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GraphDebugInfo_StackTrace* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.GraphDebugInfo) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(GraphDebugInfo* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  GraphDebugInfo* New(::google::protobuf::Arena* arena = nullptr) const {
