...
/* @@protoc_insertion_point(class_definition:tensorflow.NodeDef.ExperimentalDebugInfo) */ {
 public:
  ...
  void operator delete(NodeDef_ExperimentalDebugInfo* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  NodeDef_ExperimentalDebugInfo* New(::google::protobuf::Arena* arena = nullptr) const {
