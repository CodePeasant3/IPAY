...
extern const uint32_t VariableSynchronization_internal_data_[];
...
extern const uint32_t VariableAggregation_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.SaveSliceInfoDef) */ {
 public:
  ...
  void operator delete(SaveSliceInfoDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SaveSliceInfoDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.VariableDef) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(VariableDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  VariableDef* New(::google::protobuf::Arena* arena = nullptr) const {
