...
extern const uint32_t OptimizedFunctionGraph_OptimizationSource_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.OptimizedFunctionGraph) */ {
 public:
  ...
  void operator delete(OptimizedFunctionGraph* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  OptimizedFunctionGraph* New(::google::protobuf::Arena* arena = nullptr) const {
