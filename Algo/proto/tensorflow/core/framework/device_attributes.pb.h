...
/* @@protoc_insertion_point(class_definition:tensorflow.InterconnectLink) */ {
 public:
  ...
  void operator delete(InterconnectLink* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  InterconnectLink* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.LocalLinks) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(LocalLinks* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  LocalLinks* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.DeviceLocality) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DeviceLocality* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DeviceLocality* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.DeviceAttributes) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DeviceAttributes* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DeviceAttributes* New(::google::protobuf::Arena* arena = nullptr) const {
