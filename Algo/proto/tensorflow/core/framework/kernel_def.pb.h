...
/* @@protoc_insertion_point(class_definition:tensorflow.KernelDef.AttrConstraint) */ {
 public:
  ...
  void operator delete(KernelDef_AttrConstraint* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  KernelDef_AttrConstraint* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.KernelDef) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(KernelDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  KernelDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.KernelList) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(KernelList* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  KernelList* New(::google::protobuf::Arena* arena = nullptr) const {
