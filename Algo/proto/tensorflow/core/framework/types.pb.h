...
constexpr DataType DataType_MAX = static_cast<DataType>(130);
constexpr int DataType_ARRAYSIZE = 130 + 1;
...
/* @@protoc_insertion_point(class_definition:tensorflow.SerializedDType) */ {
 public:
  ...
  void operator delete(SerializedDType* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SerializedDType* New(::google::protobuf::Arena* arena = nullptr) const {
