...
extern const uint32_t NodeClass_internal_data_[];
...
extern const uint32_t AutotuneAlgorithm_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.model.ModelProto.OptimizationParams) */ {
 public:
  ...
  void operator delete(ModelProto_OptimizationParams* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ModelProto_OptimizationParams* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.model.ModelProto.Node.Parameter) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ModelProto_Node_Parameter* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ModelProto_Node_Parameter* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.model.ModelProto.Node) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ModelProto_Node* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ModelProto_Node* New(::google::protobuf::Arena* arena = nullptr) const {
