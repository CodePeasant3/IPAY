...
/* @@protoc_insertion_point(class_definition:tensorflow.RegisteredGradient) */ {
 public:
  ...
  void operator delete(RegisteredGradient* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RegisteredGradient* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.FunctionDef.ArgAttrs) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(FunctionDef_ArgAttrs* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  FunctionDef_ArgAttrs* New(::google::protobuf::Arena* arena = nullptr) const {
