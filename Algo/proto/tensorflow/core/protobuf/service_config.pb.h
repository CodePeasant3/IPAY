...
/* @@protoc_insertion_point(class_definition:tensorflow.data.experimental.WorkerConfig) */ {
 public:
  ...
  void operator delete(WorkerConfig* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  WorkerConfig* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.experimental.DispatcherConfig) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DispatcherConfig* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DispatcherConfig* New(::google::protobuf::Arena* arena = nullptr) const {
