...
extern const uint32_t BundleHeaderProto_Endianness_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.BundleHeaderProto) */ {
 public:
  ...
  void operator delete(BundleHeaderProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  BundleHeaderProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.BundleEntryProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(BundleEntryProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  BundleEntryProto* New(::google::protobuf::Arena* arena = nullptr) const {
