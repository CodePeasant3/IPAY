...
extern const uint32_t ProcessingModeDef_ShardingPolicy_internal_data_[];
...
extern const uint32_t DataServiceMetadata_Compression_internal_data_[];
...
constexpr DataServiceMetadata_Compression DataServiceMetadata_Compression_Compression_MAX = static_cast<DataServiceMetadata_Compression>(2);
constexpr int DataServiceMetadata_Compression_Compression_ARRAYSIZE = 2 + 1;
const ::google::protobuf::EnumDescriptor*
...
extern const uint32_t DeploymentMode_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.ProcessingModeDef) */ {
 public:
  ...
  void operator delete(ProcessingModeDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ProcessingModeDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.DataServiceMetadata) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DataServiceMetadata* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DataServiceMetadata* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.DataServiceConfig) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DataServiceConfig* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DataServiceConfig* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.data.CrossTrainerCacheOptions) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(CrossTrainerCacheOptions* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CrossTrainerCacheOptions* New(::google::protobuf::Arena* arena = nullptr) const {
