...
/* @@protoc_insertion_point(class_definition:tensorflow.JobDef) */ {
 public:
  ...
  void operator delete(JobDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  JobDef* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ClusterDef) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ClusterDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ClusterDef* New(::google::protobuf::Arena* arena = nullptr) const {
