...
/* @@protoc_insertion_point(class_definition:tensorflow.DebuggedSourceFile) */ {
 public:
  ...
  void operator delete(DebuggedSourceFile* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DebuggedSourceFile* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.DebugTensorWatch) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DebugTensorWatch* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DebugTensorWatch* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.DebuggedSourceFiles) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DebuggedSourceFiles* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DebuggedSourceFiles* New(::google::protobuf::Arena* arena = nullptr) const {
