...
extern const uint32_t SaverDef_CheckpointFormatVersion_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.SaverDef) */ {
 public:
  ...
  void operator delete(SaverDef* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SaverDef* New(::google::protobuf::Arena* arena = nullptr) const {
