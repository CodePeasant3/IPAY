...
/* @@protoc_insertion_point(class_definition:tensorflow.MatmulProto) */ {
 public:
  ...
  void operator delete(MatmulProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MatmulProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ConvolutionProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ConvolutionProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ConvolutionProto* New(::google::protobuf::Arena* arena = nullptr) const {
