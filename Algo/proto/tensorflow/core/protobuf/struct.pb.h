...
#ifndef tensorflow_2fcore_2fprotobuf_2fstruct_2eproto_2epb_2eh
#define tensorflow_2fcore_2fprotobuf_2fstruct_2eproto_2epb_2eh
...
extern const uint32_t TypeSpecProto_TypeSpecClass_internal_data_[];
...
/* @@protoc_insertion_point(class_definition:tensorflow.NoneValue) */ {
 public:
  ...
  void operator delete(NoneValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(NoneValue));
  }
#endif
  ...
  NoneValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.TensorSpecProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(TensorSpecProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(TensorSpecProto));
  }
#endif
  ...
  TensorSpecProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.BoundedTensorSpecProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(BoundedTensorSpecProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(BoundedTensorSpecProto));
  }
#endif
  ...
  BoundedTensorSpecProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.DictValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(DictValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(DictValue));
  }
#endif
  ...
  DictValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.NamedTupleValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(NamedTupleValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(NamedTupleValue));
  }
#endif
  ...
  NamedTupleValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.PairValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(PairValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(PairValue));
  }
#endif
  ...
  PairValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.StructuredValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(StructuredValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(StructuredValue));
  }
#endif
  ...
  StructuredValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.TupleValue) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(TupleValue* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  TupleValue* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.TypeSpecProto) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(TypeSpecProto* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(TypeSpecProto));
  }
#endif
  ...
  TypeSpecProto* New(::google::protobuf::Arena* arena = nullptr) const {
...
inline void TypeSpecProto::set_allocated_type_spec_class_name(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.type_spec_class_name_.IsDefault()) {
...
#endif  // tensorflow_2fcore_2fprotobuf_2fstruct_2eproto_2epb_2eh
