...
/* @@protoc_insertion_point(class_definition:tensorflow.eager.ResourceDtypeAndShape) */ {
 public:
  ...
  void operator delete(ResourceDtypeAndShape* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ResourceDtypeAndShape* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.eager.RemoteTensorHandle) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(RemoteTensorHandle* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  RemoteTensorHandle* New(::google::protobuf::Arena* arena = nullptr) const {
