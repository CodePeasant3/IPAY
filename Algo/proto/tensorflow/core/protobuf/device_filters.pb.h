...
/* @@protoc_insertion_point(class_definition:tensorflow.TaskDeviceFilters) */ {
 public:
  ...
  void operator delete(TaskDeviceFilters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  TaskDeviceFilters* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.JobDeviceFilters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(JobDeviceFilters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  JobDeviceFilters* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ClusterDeviceFilters) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ClusterDeviceFilters* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ClusterDeviceFilters* New(::google::protobuf::Arena* arena = nullptr) const {
