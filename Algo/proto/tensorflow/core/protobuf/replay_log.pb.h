...
/* @@protoc_insertion_point(class_definition:tensorflow.NewReplaySession) */ {
 public:
  ...
  void operator delete(NewReplaySession* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  NewReplaySession* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.ReplayOp) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ReplayOp* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ReplayOp* New(::google::protobuf::Arena* arena = nullptr) const {
