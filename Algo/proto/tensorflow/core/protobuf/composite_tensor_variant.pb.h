...
/* @@protoc_insertion_point(class_definition:tensorflow.CompositeTensorVariantMetadata) */ {
 public:
  ...
  void operator delete(CompositeTensorVariantMetadata* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  CompositeTensorVariantMetadata* New(::google::protobuf::Arena* arena = nullptr) const {
