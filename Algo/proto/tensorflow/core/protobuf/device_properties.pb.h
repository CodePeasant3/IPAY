...
/* @@protoc_insertion_point(class_definition:tensorflow.DeviceProperties) */ {
 public:
  ...
  void operator delete(DeviceProperties* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  DeviceProperties* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.NamedDevice) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(NamedDevice* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  NamedDevice* New(::google::protobuf::Arena* arena = nullptr) const {
