...
/* @@protoc_insertion_point(class_definition:xla.AutotuneResults.Entry) */ {
 public:
  ...
  void operator delete(AutotuneResults_Entry* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AutotuneResults_Entry* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:xla.AutotuningLogs) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AutotuningLogs* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AutotuningLogs* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:xla.AutotuneResults) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(AutotuneResults* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  AutotuneResults* New(::google::protobuf::Arena* arena = nullptr) const {
