...
/* @@protoc_insertion_point(class_definition:xla.HloProfilePrinterData.HloInstructionInfo) */ {
 public:
  ...
  void operator delete(HloProfilePrinterData_HloInstructionInfo* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  HloProfilePrinterData_HloInstructionInfo* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:xla.HloProfilePrinterData.HloComputationInfo) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(HloProfilePrinterData_HloComputationInfo* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  HloProfilePrinterData_HloComputationInfo* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:xla.HloProfilePrinterData) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(HloProfilePrinterData* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  HloProfilePrinterData* New(::google::protobuf::Arena* arena = nullptr) const {
