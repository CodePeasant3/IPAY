...
/* @@protoc_insertion_point(class_definition:tensorflow.MemChunk) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MemChunk* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MemChunk* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.MemAllocatorStats) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MemAllocatorStats* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MemAllocatorStats* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.BinSummary) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(BinSummary* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  BinSummary* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:tensorflow.MemoryDump) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(MemoryDump* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  MemoryDump* New(::google::protobuf::Arena* arena = nullptr) const {
